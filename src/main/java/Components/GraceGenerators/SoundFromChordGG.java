...
public class SoundFromChordGG {

    // Generate a (short) SoundPhrase from a chord
    // to use as parameter for an harmony beautifier
    ...
    public SoundPhrase generate(Chord chordBase){
    ...
    public SoundFromChordGG(){
        this.timeUnit = TRIPLE;
        this.maxChord = 3;
    };

    public SoundFromChordGG(int timeUnit, int maxChord){
